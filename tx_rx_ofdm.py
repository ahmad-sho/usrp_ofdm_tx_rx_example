...
class tx_rx_ofdm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0_1_1 = blocks.file_sink(gr.sizeof_char*1, 'data_rx_crc', False)
        self.blocks_file_sink_0_1_1.set_unbuffered(False)
        self.blocks_file_sink_0_1_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'data_rx_symbols', False)
        self.blocks_file_sink_0_1_0.set_unbuffered(False)
        self.blocks_file_sink_0_1 = blocks.file_sink(gr.sizeof_char*1, 'data_rx_stream', False)
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, 'data_tx', False)
